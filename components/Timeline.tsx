...
const MOMENTS = [
  {
    id: 1,
    label: "The Beginning",
    title: "When The Love Began",
    desc: "A car ride. A pink head wrap. A blue floral shirt. That ordinary afternoon quietly became the start of everything.",
  ...
  },
  {
    id: 3,
    label: "Ramadan 2024",
    title: "Our Ramadan Dates",
    desc: "Breaking fast together. Watching you in your element — faithful, calm, luminous — was one of the most beautiful things I've witnessed.",
  ...
  },
  {
    ...
    title: "Genesis Cinema & Beyond",
    desc: "You showed up with that smile — the one that makes the whole world stop. You've been lighting up every room we walk into ever since.",
    imagePath: "/images/genesis-cinema.webp",
    imagePos: "top",
    side: "right",
  },
  {
    id: 5,
    label: "At My Place",
    title: "When Home Became Ours",
    desc: "You in my Inter Miami jersey, wearing my space like you belong there. Because you do — in every corner of my world.",
